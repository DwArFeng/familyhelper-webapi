...
import com.dwarfeng.familyhelper.webapi.sdk.bean.life.disp.JSFixedFastJsonDispPbNode;
...
public class PbNodeController {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(PbNodeController.class);
