...
import com.dwarfeng.familyhelper.webapi.sdk.bean.life.disp.JSFixedFastJsonDispActivityTemplateParticipant;
...
public class ActivityTemplateParticipantController {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(ActivityTemplateParticipantController.class);
    ...
    childForActivityTemplateDisp(
        ...
        try {
            ...
            PagedData<DispActivityTemplateParticipant> childForActivityTemplateDisp =
                    service.childForActivityTemplateDisp(
