...
import com.dwarfeng.fileio.sdk.bean.entity.JSFixedFastJsonExportTemplateInfo;
 ...
 * @since 2.1.0
 */
@RestController("fileioExportTemplateController")
@RequestMapping("/api/v1/fileio")
public class ExportTemplateController {

    private static final Logger LOGGER = LoggerFactory.getLogger(ExportTemplateController.class);
    ...
    private final ExportTemplateResponseService service;
    private final ServiceExceptionMapper sem;

    private final BeanTransformer<ExportTemplateInfo, JSFixedFastJsonExportTemplateInfo> beanTransformer;

    private final CommonsMultipartResolver commonsMultipartResolver;

    public ExportTemplateController(
            ExportTemplateResponseService service,
            ServiceExceptionMapper sem,
            BeanTransformer<ExportTemplateInfo, JSFixedFastJsonExportTemplateInfo> beanTransformer,
    ...
    @GetMapping("/export-template/{taskSettingId}&{identifier}/exists")
    @BehaviorAnalyse
    @LoginRequired
    @PermissionRequired("webapi.controller_permitted.fileio.export_template.exists")
    ...
    @GetMapping("/export-template/{taskSettingId}&{identifier}")
    @BehaviorAnalyse
    @LoginRequired
    @PermissionRequired("webapi.controller_permitted.fileio.export_template.get")
    public FastJsonResponseData<JSFixedFastJsonExportTemplateInfo> get(
            HttpServletRequest request,
            @PathVariable("taskSettingId") long taskSettingId,
            @PathVariable("identifier") String identifier
    ) {
        try {
            ExportTemplateInfo exportTemplateInfo = service.get(new TaskSettingItemKey(taskSettingId, identifier));
            return FastJsonResponseData.of(ResponseDataUtil.good(
                    JSFixedFastJsonExportTemplateInfo.of(exportTemplateInfo)
            ));
        } catch (Exception e) {
            LOGGER.warn("Controller 异常，信息如下：", e);
            return FastJsonResponseData.of(ResponseDataUtil.bad(e, sem));
    ...
    @GetMapping("/export-template/all")
    @BehaviorAnalyse
    @SkipRecord
    @LoginRequired
    @PermissionRequired("webapi.controller_permitted.fileio.export_template.all")
    public FastJsonResponseData<JSFixedFastJsonPagedData<JSFixedFastJsonExportTemplateInfo>> all(
            HttpServletRequest request, @RequestParam("page") int page, @RequestParam("rows") int rows
    ) {
        try {
            PagedData<ExportTemplateInfo> all = service.all(new PagingInfo(page, rows));
            PagedData<JSFixedFastJsonExportTemplateInfo> transform = PagingUtil.transform(all, beanTransformer);
    ...
    @GetMapping("/task-setting/{taskSettingId}/export-template")
    @BehaviorAnalyse
    @SkipRecord
    @LoginRequired
    @PermissionRequired("webapi.controller_permitted.fileio.export_template.child_for_task_setting")
    public FastJsonResponseData<JSFixedFastJsonPagedData<JSFixedFastJsonExportTemplateInfo>> childForTaskSetting(
            HttpServletRequest request,
            @PathVariable Long taskSettingId,
            @RequestParam("page") int page, @RequestParam("rows") int rows
    ) {
        try {
            PagedData<ExportTemplateInfo> childForTaskSetting = service.childForTaskSetting(
                    new LongIdKey(taskSettingId), new PagingInfo(page, rows)
            );
            PagedData<JSFixedFastJsonExportTemplateInfo> transform = PagingUtil.transform(
    ...
    @PostMapping("/export-template/create")
    @BehaviorAnalyse
    @LoginRequired
    @PermissionRequired("webapi.controller_permitted.fileio.export_template.create")
    ...
    @SuppressWarnings("DuplicatedCode")
    @PostMapping("/export-template/remove")
    @BehaviorAnalyse
    @LoginRequired
    @PermissionRequired("webapi.controller_permitted.fileio.export_template.remove")
    ...
    @SuppressWarnings("DuplicatedCode")
    @GetMapping("/export-template/{taskSettingId}&{identifier}/download-file")
    @BehaviorAnalyse
    @LoginRequired
    @PermissionRequired("webapi.controller_permitted.fileio.export_template.download_file")
    ...
    @SuppressWarnings("DuplicatedCode")
    @PostMapping("/export-template/download-file-stream")
    @BehaviorAnalyse
    @LoginRequired
    @PermissionRequired("webapi.controller_permitted.fileio.export_template.download_file_stream")
     ...
     */
    @SuppressWarnings("DuplicatedCode")
    @PostMapping("/export-template/{taskSettingId}&{identifier}/request-stream-voucher")
    @BehaviorAnalyse
    @LoginRequired
    @PermissionRequired("webapi.controller_permitted.fileio.export_template.request_stream_voucher")
     ...
     */
    @SuppressWarnings("DuplicatedCode")
    @GetMapping("/export-template/download-by-voucher")
    @BehaviorAnalyse
    ...
    @SuppressWarnings("DuplicatedCode")
    @PostMapping("/export-template/{taskSettingId}&{identifier}/upload")
    @BehaviorAnalyse
    @LoginRequired
    @PermissionRequired("webapi.controller_permitted.fileio.export_template.upload")
    ...
    @SuppressWarnings("DuplicatedCode")
    @PostMapping("/export-template/{taskSettingId}&{identifier}/upload-stream")
    @BehaviorAnalyse
    @LoginRequired
    @PermissionRequired("webapi.controller_permitted.fileio.export_template.upload_stream")
