...
import com.dwarfeng.familyhelper.webapi.sdk.bean.life.disp.JSFixedFastJsonDispActivityTemplateDataInfo;
...
public class ActivityTemplateDataInfoController {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(ActivityTemplateDataInfoController.class);
