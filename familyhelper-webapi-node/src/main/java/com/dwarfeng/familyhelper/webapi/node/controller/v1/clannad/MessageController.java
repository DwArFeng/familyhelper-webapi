...
import com.dwarfeng.familyhelper.webapi.sdk.bean.clannad.disp.JSFixedFastJsonDispMessage;
...
public class MessageController {
    ...
    public FastJsonResponseData<JSFixedFastJsonLongIdKey> create(
        ...
        try {
            StringIdKey operateUserKey = new StringIdKey(tokenHandler.getUserId(request));
