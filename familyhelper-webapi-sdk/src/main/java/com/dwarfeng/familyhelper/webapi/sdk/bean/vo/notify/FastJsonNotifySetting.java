...
public class FastJsonNotifySetting implements Bean {
    ...
    private static final long serialVersionUID = 8941965220863898667L;
    ...
    public FastJsonNotifySetting(
            FastJsonLongIdKey key, String label, boolean enabled, String requiredPermission, String remark
    ) {
        this.key = key;
        this.label = label;
