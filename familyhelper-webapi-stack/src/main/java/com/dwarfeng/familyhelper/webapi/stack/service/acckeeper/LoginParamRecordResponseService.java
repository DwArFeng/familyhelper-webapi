...
public interface LoginParamRecordResponseService extends Service {
    ...
    DispLoginParamRecord getDisp(RecordKey key) throws ServiceException;

    PagedData<DispLoginParamRecord> allDisp(PagingInfo pagingInfo) throws ServiceException;

    PagedData<DispLoginParamRecord> childForLoginHistoryDisp(LongIdKey loginHistoryKey, PagingInfo pagingInfo)
            throws ServiceException;
}
